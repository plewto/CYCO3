...
(load-config-file "sj/emu/procussion/standard-kit")
(load-config-file "sj/emu/procussion/tuned-instruments")
(load-config-file "sj/emu/procussion/latin-drums")
(load-config-file "sj/emu/procussion/percussion1")
(load-config-file "sj/emu/procussion/toolkit")
(load-config-file "sj/emu/procussion/thundadome")
(load-config-file "sj/emu/procussion/beatbox")
(load-config-file "sj/emu/procussion/percussives")
(load-config-file "sj/emu/procussion/more-cymbals")
(load-config-file "sj/emu/procussion/all-cymbals")
(load-config-file "sj/emu/procussion/cymbals2")
(load-config-file "sj/emu/procussion/proshake")
