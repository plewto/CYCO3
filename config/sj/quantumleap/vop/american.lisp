;;;; PigIron CYCO sj config quantumleap vop american
;;;;

(defun vop-american (&key (parent ql-vop)(channel nil)
...
(defun vop-american-oo (&key (parent ql-vop)(channel nil)
			     keynumber-map articulation-map dynamic-map
			     remarks)
