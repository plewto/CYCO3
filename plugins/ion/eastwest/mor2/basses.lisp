;;;; CYCO plugins sj eastwest mor2 basses.lisp
;;;;
;;;; Instruments:
;;;;
;;;;    mor2-bass
...
(defun eb2 (&key (parent ew-bass) channel 
  ...
  (let ((inst (make-instrument 'eb2
    ...
    (make-eastwest-program-map inst '((sus "Sustain open RR")
				      (mute "Mute RR")
...
(defun hofner (&key (parent ew-bass) channel 
		    keynumber-map articulation-map dynamic-map
		    (remarks "Ministry of Rock Bass"))
  (let ((inst (make-instrument 'hofner
			       ...
			       :articulation-map articulation-map
			       :dynamic-map dynamic-map)))
    (make-eastwest-program-map inst '((sus slide trem noise)))
    (param hofner inst)
    inst))


(defun jazzman (&key (parent ew-bass) channel 
		     keynumber-map articulation-map dynamic-map
		     (remarks "Ministry of Rock Bass"))
  (let ((inst (make-instrument 'jazzman
			       ...
			       :articulation-map articulation-map
			       :dynamic-map dynamic-map)))
    (make-eastwest-program-map inst '((SUS     "Sustain")
...
(defun lakland (&key (parent ew-bass) channel 
		     keynumber-map articulation-map dynamic-map
		     (remarks "Ministry of Rock Bass"))
  (let ((inst (make-instrument 'lakland
			       ...
			       :articulation-map articulation-map
			       :dynamic-map dynamic-map)))
    (make-eastwest-program-map inst '((OPEN   "Open down")
...
(defun musicman (&key (parent ew-bass) channel 
		      keynumber-map articulation-map dynamic-map
		      (remarks "Ministry Of Rock Bass"))
  (let ((inst (make-instrument 'musicman
			       ...
			       :articulation-map articulation-map
			       :dynamic-map dynamic-map)))
    (make-eastwest-program-map inst '((SUS    "Sustain RR")
				      (OPEN   "Open down")
				      (LEG    "Legato")
				      (SLIDE  "Open slide down")
				      (SLIDE2 "Open slide down fast")
...
(defun rickenbacker (&key (parent ew-bass) channel 
			  keynumber-map articulation-map dynamic-map
			  (remarks "Ministry of Rock Bass"))
...
(defun silvertone (&key (parent ew-bass) channel 
			keynumber-map articulation-map dynamic-map
			(remarks "Ministry of Rock Bass"))
...
(defun stingray (&key (parent ew-bass) channel 
		      keynumber-map articulation-map dynamic-map
		      (remarks "Ministry Of Rock Bass"))
  (let ((inst (make-instrument 'stingray
			       ...
			       :articulation-map articulation-map
			       :dynamic-map dynamic-map)))
    (make-eastwest-program-map inst '((LONG       "Sustain long RR")
...
(defun hofner-fingered (&key (parent ew-bass) channel 
			     keynumber-map articulation-map dynamic-map
			     (remarks "Ministry of Rock Bass"))
...
(defun lakland-fingered (&key (parent ew-bass) channel 
			      keynumber-map articulation-map dynamic-map
			      (remarks "Ministry of Rock Bass"))
  (let ((inst (make-instrument 'lakland-fingered
			       ...
			       :articulation-map articulation-map
			       :dynamic-map dynamic-map)))
    (make-eastwest-program-map inst '((OPEN   "Open sustain")
				      (LEG    "Legatto")
				      (SLIDE  "Slide down")
				      (SLIDE2 "Slide up")
...
(defun silvertone-fingered (&key (parent ew-bass) channel 
				 keynumber-map articulation-map dynamic-map
				 (remarks "Ministry of Rock Bass"))
  (let ((inst (make-instrument 'silvertone-fingered
			       ...
			       :articulation-map articulation-map
			       :dynamic-map dynamic-map)))
    (make-eastwest-program-map inst '((SUS    "Sustained")
				      (SLIDE  "Slide up")
				      (BEND   "Bend up")
				      (SLIDE2 "Slide down")
				      (NOISE  "Noise")))
...
(defun stingray-fingered (&key (parent ew-bass) channel 
			       keynumber-map articulation-map dynamic-map
			       (remarks "Ministry of Rock Bass"))
