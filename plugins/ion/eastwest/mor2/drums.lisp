...
(let* ((kick-list '((A . (35))
  ...
  (instrument m2-kick :parent ew-drums :remarks "Ministry of Rock Drums" :transient nil :keynumber-map kick-map)
  (instrument m2-snare :parent ew-drums :remarks "Ministry of Rock Drums" :transient nil :keynumber-map snare-map)
  (instrument m2-tom :parent ew-drums :remarks "Ministry of Rock Drums" :transient nil :keynumber-map tom-map)
  (instrument m2-cow :parent ew-drums :remarks "Ministry of Rock Drums" :transient nil :keynumber-map cow-map)
  (instrument m2-hat :parent ew-drums :remarks "Ministry of Rock Drums" :transient nil :keynumber-map hat-map)
  (instrument m2-cym :parent ew-drums :remarks "Ministry of Rock Drums" :transient nil :keynumber-map cym-map)
  (instrument m2-ride :parent m2-cym :remarks "Ministry of Rock Drums" :transient nil :keynumber-map ride-map)
