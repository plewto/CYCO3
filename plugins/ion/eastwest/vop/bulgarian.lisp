;;;; CYCO plugins sj eastwest VOP bulgarian.lisp
;;;;

(defun vop-bulgarian (&key (parent ew-vop)(channel nil)
  ...
  (let ((inst (make-instrument 'vop-bulgarian
    ...
    (make-eastwest-program-map inst '(bul1 
				      bul2 
				      bul3 
				      bul4 
				      hiaheya 
...
(defun vop-bulgarian-breath (&key (parent ew-vop)(channel nil)
				  keynumber-map articulation-map dynamic-map
				  remarks)
...
(defun vop-bulgarian-deeper (&key (parent ew-vop)(channel nil)
				  keynumber-map articulation-map dynamic-map
				  remarks)
