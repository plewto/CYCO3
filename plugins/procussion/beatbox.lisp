  ...
  (defun beatbox (&key (parent procussion)(channel nil))
    (let ((bb (instrument beatbox
      ...
      (instrument bb-quinto
		  ...
		  :transient t
		  :keynumber-map (procussion-subkey-map quinto-keys))
      (instrument bb-tom
		  :parent bb
		  :remarks "Procussion BeatBox bb-tom instrument"
		  :transient t
		  :keynumber-map (procussion-subkey-map tom-keys))
