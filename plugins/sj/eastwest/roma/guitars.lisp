;;;; CYCO plugins sj eastwest roma guitars
;;;;
;;;; Instruments
;;;;
;;;;     classical-guitar
...
(defun classical-guitar (&key (parent ew-guitar)(channel nil)
  ...
  (let ((inst (make-instrument 'classical-guitar
    ...
    (make-eastwest-program-map inst
			       '((sus        "sus        :range (E1 A4)" )
...
(defun django (&key (parent ew-guitar)(channel nil)
		    keynumber-map articulation-map dynamic-map
		    remarks)
...
(defun django-chords (&key (parent ew-guitar)(channel nil)
			   keynumber-map articulation-map dynamic-map
			   remarks)
...
(defun flamenco (&key (parent ew-guitar)(channel nil)
		      keynumber-map articulation-map dynamic-map
		      remarks)
...
(defun flamenco-chords (&key (parent ew-guitar)(channel nil)
			     keynumber-map articulation-map dynamic-map
			     remarks)
