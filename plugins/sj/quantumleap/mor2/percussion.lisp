;;;; PigIron CYCo sj config quantumleap mor2-drums
;;;;
;;;; m2-drums
;;;;    m2-kick
;;;;    m2-snare
...
(let* ((kick-list '((A . (35))
  ...
  (instrument m2-kick :parent ql-drums :remarks "Ministry of Rock Drums" :transient nil)
  (instrument m2-snare :parent ql-drums :remarks "Ministry of Rock Drums" :transient nil)
  (instrument m2-tom :parent ql-drums :remarks "Ministry of Rock Drums" :transient nil)
  (instrument m2-cow :parent ql-drums :remarks "Ministry of Rock Drums" :transient nil)
  (instrument m2-hat :parent ql-drums :remarks "Ministry of Rock Drums" :transient nil)
  (instrument m2-cym :parent ql-drums :remarks "Ministry of Rock Drums" :transient nil)
  (instrument m2-ride :parent m2-cym :remarks "Ministry of Rock Drums" :transient nil)
  ;; (symbolic-keynumber-map composite-list :instrument ql-drums)
  (keynumber-map! ql-drums (symbolic-keynumber-map composite-list))
  
  (defun ql-drums (&optional light-load)
    "Select QL-DRUMS keynumber-map 
light-load nil -> Use default full-load map
light-load t   -> Use light-load map"
    (if light-load
	(progn
	  (format t "QL-DRUMS using light-load map~%")
      ...
      (progn
	(format t "QL-DRUMS using full-load map~%")
