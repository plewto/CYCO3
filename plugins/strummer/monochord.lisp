;;;; CYCO srtummer plugin monochord
;;;;

;; WARNING: changed name from mc-position->keynumber
(defgeneric position->keynumber (mc pos)
  (:documentation
...
(defmethod position->keynumber ((mc monochord)(pos t))
  (cond
   ((eq pos 'O) 0)
   ((eq pos 'X) +REST+)
...
;; WARNING: changed name from fm-key-positions
(defmethod key-positions ((mc monochord)(key t) &key (no-duplicates nil))
