...
(defgeneric keylist (object &key blur)
  (:documentation
   "Returns MIDI keylist used or generated by object.
Optional blur argument sets time how close in time two key events must be 
to be considered part of a chord.

Events which are within blur seconds of each other are treated as chords
and appear as a sublist in the result."))
