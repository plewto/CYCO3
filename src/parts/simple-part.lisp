...
(let ((argument-count-table (make-hash-table :size 12)))
  ...
  (setf (gethash :inv argument-count-table) 1)
  (setf (gethash :octave argument-count-table) 1)
  (setf (gethash :oct argument-count-table) 1)
