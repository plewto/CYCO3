...
(labels ((rotate (curve phase)
  ...
  (defun sawtooth->cycle (amp1 amp2 &key (steps 16)(phase 0))
...
Returns Pattern."
  ...
  (defun triangle->cycle (amp1 amp2 &key (steps 16)(phase 0))
...
Returns Pattern."
  ...
  (defun pulse->cycle (amp1 amp2 &key (steps 16)(phase 0)(width 0.5))
