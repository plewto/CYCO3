...
(defmethod clone ((mother merger) &key new-name new-parent)
  (dismiss new-name new-parent)
  (let* ((e (elements mother))
	 (a (clone (car e)))
	 (b (clone (second e))))
    (merger a b
	    :a-function (merger-function-a mother)
	    :b-function (merger-function-b mother)
	    :mixer-function (merger-mixer-function mother))))
